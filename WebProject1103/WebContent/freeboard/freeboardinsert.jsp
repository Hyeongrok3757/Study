				...
				<form action="freeboardinsert.do" method="post">
					...
					<div class="board_view">
						<table cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<th>글쓴이</th>
								<td colspan="3"><input type="text" name="fb_writer" maxlength="20" value="<%=id %>" readonly="readonly"/></td>

							</tr>
							<tr>
								<th>제목</th>
								<td colspan="3"><input type="text" name="fb_subject" size="50" />
								</td>
							</tr>
							<tr>
								<th>비밀번호</th>
								<td colspan="3"><input type="password" name="fb_pwd" />
								</td>
							</tr>
							<tr>
								<th>내용</th>
								<td colspan="3">
								<textarea width="100%" style="width: 580px; height: 200px;" name="fb_content"></textarea>
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td valign="bottom" height="35px"><a href="freeboardlist.do" id="list">
